...
import frc.robot.commands.AlgaeAlignCmd;
...
public class RobotContainer {
  ...
  // private final LowerElevatorCmd elevateLOW = new LowerElevatorCmd(m_elevator, m_leds,
  // m_shooter);
  ...
  public void configureBindingsTeleop() {
    ...
    m_driverController.rightBumper().onTrue(new AlgaeAlignCmd(m_swerve, m_selector));
  }
