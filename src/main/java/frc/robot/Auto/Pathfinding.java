...
//     // a list that acts like a buffer accepting pose2ds, sorting them and assigning the closest
// one
...
//     // I need a list separate from positionsList because I need to keep track of all consumed
// pois
//     // even after a cycle
...
//     IdealStartingState startingState = new IdealStartingState(3,
// raw_poi.getPose2d().getRotation());
...
//     // calculates the coordinates to displace the robot actual wanted position relative to the
// POI
