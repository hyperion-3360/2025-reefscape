...
public class ElevateCmd extends SequentialCommandGroup {
  ...
  public ElevateCmd(Elevator m_elevator, Shooter m_shooter, AlgaeIntake m_algaeIntake, LEDs m_leds, desiredHeight height) {
    ...
    addCommands(
        ...
        Commands.runOnce(() -> m_shooter.openBlocker()).unless(() -> m_algaeIntake.sensorTriggered()),
